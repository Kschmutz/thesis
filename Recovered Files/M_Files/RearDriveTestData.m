...
%TRL = 100;          % Torque input of rear left tire [Nm]
%TRR = 100;          % Torque input of rear right tire [Nm]
Vx0 = 10.001;           % Initial vehicle longitude speed [m/s] note: was 60*1000/3600   KDS 10/16, 
                       % DO NOT USE EXTREMELY SMALL START SPEEDS
                       % Initial negative speeds seem to not work....
Vy0 = 0;            % Initial vehicle lateral speed [m/s]
r0 = -3;             % Initial yaw rate [rad/s]
