...
set_param('AWD_ABS_VLC_Combined_PID','AlgebraicLoopSolver','LineSearch')
%% Inputs
...
%D_Slip = 0.12;            % Desired slip for PID

D_Slip_Accel = 0.12;           % Desired slip for PID (During Acceleration)    
D_Slip_Brake = -0.12;          % Desired slip for PID (During Braking)

Vx0 = 27.0;             % Initial vehicle longitude speed [m/s] note: was 60*1000/3600   KDS 10/16, 
...
Muys = .8;        % friction coefficient when sliding 
