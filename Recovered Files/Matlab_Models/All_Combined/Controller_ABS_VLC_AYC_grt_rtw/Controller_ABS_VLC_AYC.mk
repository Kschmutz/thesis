...
MODEL                = Controller_ABS_VLC_AYC
MODULES              = Controller_ABS_VLC_AYC_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = Controller_ABS_VLC_AYC.mk
MATLAB_ROOT          = D:\Program Files\MATLAB\R2012a
ALT_MATLAB_ROOT      = D:\PROGRA~2\MATLAB\R2012a
MATLAB_BIN           = D:\Program Files\MATLAB\R2012a\bin
ALT_MATLAB_BIN       = D:\PROGRA~2\MATLAB\R2012a\bin
MASTER_ANCHOR_DIR    = 
START_DIR            = D:\Dropbox\EE500\CURREN~2\MATLAB~1\ALL_CO~1
S_FUNCTIONS          = sfsup.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 3
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f C:\Users\MRSPYD~1\AppData\Roaming\MATHWO~1\MATLAB\R2012a\mexopts.bat
VISUAL_VER           = 7.1SDK
...
MODELLIB                  = Controller_ABS_VLC_AYClib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Controller_ABS_VLC_AYC_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\fuzzy\fuzzy\src
