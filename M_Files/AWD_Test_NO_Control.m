...
%% Inputs
TFL = 90;          % Torque input of front left tire [Nm]
TFR = 90;          % Torque input of front right tire [Nm]
TRL = 90;          % Torque input of rear left tire [Nm]
TRR = 90;          % Torque input of rear right tire [Nm]

Vx0 = 1.311;           % Initial vehicle longitude speed [m/s] note: was 60*1000/3600   KDS 10/16, 
...
%
%   longitudinal motion
%   Fx = Gx * Fx0, Fx0 is the pure longitudinal force
%   Gx = cos( atan (Bx * a ))
%   Bx = rx1 * cos( atan (rx2 * s)) 

%   lateral motion
%   Fy = Gy * Fy0, Fy0 is the pure lateral force
%   Gy = cos( aran (By * s))
%   By = ry1 * cos( atan (ry2 * a))  
